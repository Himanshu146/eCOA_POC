...
class SVGPath(private val src: Path) : Path(src) {
    ...
    var onSVGPathUpdatedListener: OnSVGPathUpdatedListener? = null
        internal set
    ...
    internal fun draw(canvas: Canvas) {
        paint.run {
            ...
            canvas.drawPath(this@SVGPath, this)
    ...
    private fun onPathUpdated() {
        onSVGPathUpdatedListener?.onPathUpdated()
    }
