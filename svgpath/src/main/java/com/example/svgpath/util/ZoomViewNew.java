 ...
 */
@RemoteView
public class ZoomViewNew extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public ZoomViewNew(Context context) {
        super(context);
    }


    public ZoomViewNew(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public ZoomViewNew(Context context, AttributeSet attrs, int defStyle) {
